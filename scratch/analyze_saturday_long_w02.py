...
csv_path = r'c:\Users\Dimitar\RunningCoach\completed\w02\2026-09-12-i185983848_intervals.csv'
...
print(f"Zones: Rec (<142): {time_rec/tot_mov_t*100:.1f}% ({time_rec/60:.1f} min) | GA (142-152): {time_ga/tot_mov_t*100:.1f}% ({time_ga/60:.1f} min) | MP (153-165): {time_mp/tot_mov_t*100:.1f}% ({time_mp/60:.1f} min) | LT (>165): {time_lt/tot_mov_t*100:.1f}%")
